...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
   ...
   // Find appointments between two timestamps (any doctor)
   List<Appointment> findByAppointmentTimeBetween(LocalDateTime start, LocalDateTime end);
    ...
    // Find appointments for a patient with a specific status ordered by appointment time
    List<Appointment> findByPatient_IdAndStatusOrderByAppointmentTimeAsc(Long patientId, Integer status);

   // Find appointments by patient name and time range
